...
class ResumenAnticipos {
  List<ResumenAnticiposSingle> resumenAnticiposList = [];
...
class ResumenAnticiposSingle {
  ...
  ResumenAnticiposSingle copyWith({
    String? proveedor,
    String? proyecto,
    num? m01,
    num? m02,
  ...
  factory ResumenAnticiposSingle.fromMap(Map<String, dynamic> map) {
    return ResumenAnticiposSingle(
  ...
  factory ResumenAnticiposSingle.fromJson(String source) =>
      ResumenAnticiposSingle.fromMap(json.decode(source));
  ...
  bool operator ==(Object other) {
    ...
    return other is ResumenAnticiposSingle &&
