...
themeLoader(
  ...
  emit(supraState().copyWith(
    isDark: !(testRead == 'false')? false:true,
  ));
}
...
themeColorLoader(
  ...
  Color color = hexColor != null ? Color(int.parse(hexColor.replaceFirst('#', ''), radix: 16)) : Colors.blue;
  emit(supraState().copyWith(
    themeColor: color,
  ));
}
