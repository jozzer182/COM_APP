...
//         controller.text = initialValue;
//       },
//       textAlign: isNumber || (tipoCampo == TipoCampo.fecha) ? TextAlign.end : TextAlign.start,
...
//                       .campo
//                       .cambiar(campo: campo, valor: option);
//                 },
//               );
//             },
//           ),
...
//                 .preordenDocController
//                 .campo
//                 .cambiar(campo: campo, valor: value);
//           },
//           decoration: InputDecoration(
...
//               .preordenDocController
//               .campo
//               .cambiar(campo: campo, valor: fileUploadController.text);
//           context.read<MainBloc>().add(
...
//         );
//         if (newDate != null) {
//           context.read<MainBloc>().preordenDocController.campo.cambiar(
//               campo: campo,
//               valor:
...
//             .preordenDocController
//             .campo
//             .cambiar(campo: campo, valor: value.toString());
//       },
//       items: opciones
//           .toSet()
...
//                       .preordenDocController
//                       .campo
//                       .cambiar(campo: campo, valor: valor.toString());
//                 },
//         ),
//       ],
//     );
