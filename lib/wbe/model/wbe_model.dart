...
class Wbe {
  ...
  List<ToCelda> titles = [
    ...
    ToCelda(valor: 'Descripción', flex: 2),
    ToCelda(valor: '1ER Nivel', flex: 2),
    ToCelda(valor: 'Status SAP', flex: 2),
...
class WbeSingle {
  ...
  List<ToCelda> get celdas => [
        ToCelda(valor: wbe, flex: 2),
        ToCelda(valor: descripcion, flex: 2),
        ToCelda(valor: wbe1, flex: 2),
        ToCelda(valor: status, flex: 2),
        ToCelda(valor: proyecto, flex: 2),
      ];
