...
class ResumenProyecto {
  List<ResumenProyectoSingle> resumenproyectoList = [];
...
class ResumenProyectoSingle {
  ...
  ResumenProyectoSingle copyWith({
    String? proveedor,
    num? m01,
    num? m02,
    num? m03,
    ...
    return ResumenProyectoSingle(
      proyecto: proveedor ?? this.proyecto,
      m01: m01 ?? this.m01,
      m02: m02 ?? this.m02,
      m03: m03 ?? this.m03,
      m04: m04 ?? this.m04,
  ...
  factory ResumenProyectoSingle.fromMap(Map<String, dynamic> map) {
    return ResumenProyectoSingle(
      proyecto: map['proveedor'] ?? '',
      m01: map['m01']?.tonum() ?? 0,
      m02: map['m02']?.tonum() ?? 0,
      m03: map['m03']?.tonum() ?? 0,
      m04: map['m04']?.tonum() ?? 0,
  ...
  factory ResumenProyectoSingle.fromJson(String source) =>
      ResumenProyectoSingle.fromMap(json.decode(source));

  @override
  String toString() {
    return 'ResumenProyecto(proveedor: $proyecto, m01: $m01, m02: $m02, m03: $m03, m04: $m04, m05: $m05, m06: $m06, m07: $m07, m08: $m08, m09: $m09, m10: $m10, m11: $m11, m12: $m12)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is ResumenProyectoSingle &&
  ...
  List<ToCelda> get celdas => [
        ToCelda(valor: proyecto.toUpperCase(), flex: 5),
        ToCelda(
